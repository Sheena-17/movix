...
export const DetailsBanner = ({ video, crew }) => {
    ...
    console.log("Data in the DetailsBanner Component is : - " , data);
    ...
    console.log("Data in the Details Banner Component is : - " ,data);
            ...
            {!loading ? (
                <>
                    ...
                    <ContentWrapper>
                        ...
                        <VideoPopup show = {show} setShow = {setShow}  videoId = {videoId} setVideoId={setVideoId} mediaType={mediaType}/>
                    </ContentWrapper>
                    </React.Fragment>
                    )}
                </>
